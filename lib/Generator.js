        ...
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
                if (Reader_1.Reader.__bindFile(migrations_path) && Config_1.Config.__init(config_path) && DB_1.DB.__init() && typeof DB_1.DB.__connect() !== 'undefined') {
                    ...
                    if (item) {
                        let migrator = require(path.join(__dirname, `/../../../${Config_1.Config.__get('is_dev') ? 'dev' : 'prod'}/${item.migrator}`)).default;
                        let migratorInstance = new migrator(DB_1.DB.__connect(), name, item);
