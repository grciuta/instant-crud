            ...
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                this.conn.createCollection(this.name, {}, (err, collection) => __awaiter(this, void 0, void 0, function* () {
                    if (err) {
                        ...
                        // generate model...
                        let modelGen = new ModelGenerator_1.ModelGenerator('interface', this.name, 'interfaces', `${this.name}.ts`);
                        ...
                        // generate repository...
                        let repositoryGen = new RepositoryGenerator_1.RepositoryGenerator('repository', this.name, 'repositories', `${this.name}.ts`);
                        ...
                        // generate interface...
                        let modelInstanceGen = new ModelInstanceGenerator_1.ModelInstanceGenerator('model', this.name, 'models', `${this.name}.ts`);
